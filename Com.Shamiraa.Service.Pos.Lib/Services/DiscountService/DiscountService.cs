...
using Com.Shamiraa.Service.Pos.Lib.Models.Discount;
...
using MongoDB.Bson;
using HashidsNet;
using Com.Shamiraa.Service.Pos.Lib.ViewModels.Discount;
using Com.Danliris.Service.Inventory.Lib.Helpers;
using static Com.Shamiraa.Service.Pos.Lib.ViewModels.Discount.DiscountViewModel;
...
namespace Com.Shamiraa.Service.Pos.Lib.Services.DiscountService
{
